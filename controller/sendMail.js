              ...
              <tr>
                <td align="center" valign="top" style="padding: 36px 24px;">
                  <a href="https://${domain}" target="_blank" style="display: inline-block;">
                    <img src="https://telegra.ph/file/ae485f6c7def2f2163552.png" alt="Logo" border="0" width="100" style="display: block; width: 100px; max-width: 100px; min-width: 100px;">
                  </a>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                  <p style="margin: 0;">Kamu menerima email ini karena kami mendeteksi adanya permintaan verifikasi akun. Jika Kamu tidak meminta verifikasi akun, Kamu dapat menghapus email ini dengan aman.</p>
                </td>
              </tr>
